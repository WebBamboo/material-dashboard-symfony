...
use Webbamboo\MaterialDashboard\Generator\Generator as MyGenerator;
...
final class MakeCrud extends AbstractMaker
{
    ...
    public function __construct(DoctrineHelper $doctrineHelper, FormTypeRenderer $formTypeRenderer, MyGenerator $myGenerator)
    {
    ...
    public function generate(InputInterface $input, ConsoleStyle $io, Generator $generator)
    {
        ...
        if (null !== $entityDoctrineDetails->getRepositoryClass()) {
            $repositoryClassDetails = $this->myGenerator->createClassNameDetails(
        ...
        $controllerClassDetails = $this->myGenerator->createClassNameDetails(
        ...
        $iter = 0;
        do {
            $formClassDetails = $this->myGenerator->createClassNameDetails(
        ...
        $this->myGenerator->generateController(
        ...
        foreach ($templates as $template => $variables) {
            $this->myGenerator->generateTemplate(
